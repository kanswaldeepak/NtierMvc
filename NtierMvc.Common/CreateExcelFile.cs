...
namespace NtierMvc.Common
{
    public class CreateExcelFile
    {
        ...
                /// 
        public static bool CreateExcelDocument(DataTable dt, string excelFilename, bool includeAutoFilter)
        {
            try
            {
                using (SpreadsheetDocument document = SpreadsheetDocument.Create(excelFilename, SpreadsheetDocumentType.Workbook))
                {
                    WriteExcelFile(dt, document, includeAutoFilter);
                }
        ...
        private static void WriteExcelFile(DataTable dt, SpreadsheetDocument spreadsheet, bool includeAutoFilter)
        {
            // Reset rows cache
