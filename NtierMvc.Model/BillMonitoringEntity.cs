...
{
    public class BillMonitoringEntity
    {
    ...
    public class BillMonitoringEntityDetails
    {
        public BillMonitoringEntity vmbEn { get; set; }
        public List<BillMonitoringEntity> lstVBM { get; set; }
        public int totalcount { get; set; }
        public BillMonitoringEntityDetails()
        {
            vmbEn = new BillMonitoringEntity();
            lstVBM = new List<BillMonitoringEntity>();
        }
    }
