...
namespace NtierMvc.API.Controllers.Application
{
    public class StoresDetailsController : ApiController
    {
        ...
        public IHttpActionResult FetchGoodsRecieptList(int pageIndex, int pageSize)
        {
            return Ok(_repository.FetchGoodsRecieptList(pageIndex, pageSize));
        }
        ...
        public IHttpActionResult SaveGoodsRecieptEntryDetails(GoodsRecieptEntity iEntity)
        {
        ...
        public IHttpActionResult GetGRDetailsPopup()
        {
            return Ok(_repository.GetGRDetailsPopup());
        }
