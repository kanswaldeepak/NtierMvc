...
namespace NtierMvc.Models
{
    public class BaseModel
    {
        ...
        public List<DropDownEntity> GetDropDownList(string TableName, string ListType, string DataValueField, string DataTextField, string Property, string ColumnName, string orderBy = null, string orderByColumn = null, string Property1 = null, string ColumnName1 = null, string Property2 = null, string ColumnName2 = null, string Property3 = null, string ColumnName3 = null, string Property4 = null, string ColumnName4 = null)
        {
            ...
            using (HttpClient client = LocalUtility.InitializeHttpClient(baseAddress))
            {
                HttpResponseMessage response = client.GetAsync(baseAddress + "/GetDropDownList?TableName=" + TableName + "&ListType=" + ListType + "&DataValueField=" + DataValueField + "&DataTextField=" + DataTextField + "&Property=" + Property + "&ColumnName=" + ColumnName + "&orderBy=" + orderBy + "&orderByColumn=" + orderByColumn + "&Property1=" + Property1 + "&ColumnName1=" + ColumnName1 + "&Property2=" + Property2 + "&ColumnName2=" + ColumnName2 + "&Property3=" + Property3 + "&ColumnName3=" + ColumnName3 + "&Property4=" + Property4 + "&ColumnName4=" + ColumnName4).Result;
                if (response.IsSuccessStatusCode)
                {
                    var data = response.Content.ReadAsStringAsync().Result;
                    lstDropDownEntity = JsonConvert.DeserializeObject<List<DropDownEntity>>(data);
