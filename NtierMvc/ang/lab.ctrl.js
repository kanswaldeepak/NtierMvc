angular.module('App').controller("Laboratory", function ($scope, $http, $timeout) {
    var CR=this;
    CR.sdata={p:1};
    CR.data={};
    ...
    CR.view_maping_facs=function(rob, show_unmapped){
        ...
        CR.sel_lab=rob;
        show_loader();
        $http({url: API_URL+'psamples/lab_maping_facs/'+rob.lab_id, params:CR.sdata_unmapped}).success(
            function(res){
    ...
    CR.list_unmapped_facs=function(){
        CR.search_unmapped='';
        show_loader();
        $http({url: API_URL+'psamples/lab_unmapped_facs/'+CR.sel_lab.lab_id, params:CR.sdata_unmapped}).success(
            function(res){
                CR.unmapped_facs=res.unmapped_facs;
    ...
    CR.pick_fac_all=function(){
        ...
        open_confirm_bootbox("Confirmation", "Are you sure to map all listed facilities?", callback);
    }
    CR.unpick_fac=function(fac_id, i){
        ...
        var cmsg=fac_id?"Are you sure to remove this?":"Are you sure to remove all showing facs?";
